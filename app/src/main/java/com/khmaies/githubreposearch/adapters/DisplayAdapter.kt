package com.khmaies.githubreposearch.adapters

import android.content.Context

import android.support.v7.widget.RecyclerView
import com.khmaies.githubreposearch.adapters.DisplayAdapter.MyViewHolder
         ...
         private fun bookmarkRepository(current: Repository?) {
            ...
            current?.let {
                ...
                realm.executeTransactionAsync(
                        ...
                        {
                            context.toast("Error Occurred "+it.message)})
            }
        }
